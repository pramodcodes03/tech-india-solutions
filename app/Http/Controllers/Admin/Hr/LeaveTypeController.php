...
class LeaveTypeController extends Controller
{
    ...
    private function validated(Request $r, ?int $id = null): array
    {
        return $r->validate([
            ...
            'accrual_enabled' => ['nullable', 'boolean'],
            'accrual_rate' => ['nullable', 'numeric', 'min:0'],
            'accrual_frequency' => ['nullable', 'in:monthly,half_yearly,annual'],
            'accrue_after_probation' => ['nullable', 'boolean'],
            'min_working_days' => ['nullable', 'integer', 'min:0', 'max:1000'],
