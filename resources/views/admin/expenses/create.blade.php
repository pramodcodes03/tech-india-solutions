<x-layout.admin title="Add Payment">
    <x-admin.breadcrumb :items="[['label' => 'Routine Payment Tracker', 'url' => route('admin.expenses.index')], ['label' => 'Add']]" />

    <h5 class="text-lg font-semibold mb-4">Add Payment</h5>
