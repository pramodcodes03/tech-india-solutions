                ...
                <table class="table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center justify-center gap-2">
                                        <a :href="`{{ url('admin/products') }}/${item.id}`" class="btn btn-sm btn-outline-info">View</a>
                                        <a :href="`{{ url('admin/products') }}/${item.id}/edit`" class="btn btn-sm btn-outline-primary">Edit</a>
                        ...
                        <tr x-show="items.length === 0">
                            <td colspan="12" class="px-4 py-4 text-center text-gray-500">No records found.</td>
                        </tr>
                    </tbody>
                </table>
            </div>
