    ...
    <form method="POST" action="{{ route('admin.hr.salary.store', $employee) }}"
        ...
        <div class="col-span-12 lg:col-span-8 panel p-6 space-y-4">
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <div><label class="text-xs text-gray-500 uppercase font-semibold">LWF / Professional Tax</label><input type="number" step="0.01" name="professional_tax" value="{{ old('professional_tax', $current?->professional_tax ?? 200) }}" required class="form-input mt-1" /></div>
