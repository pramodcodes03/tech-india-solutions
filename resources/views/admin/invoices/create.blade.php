<x-layout.admin title="Create Invoice">
    <div x-data="invoiceForm()">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h5 class="text-xl font-bold dark:text-white-light">Create Invoice</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the details to generate a new invoice</p>
            </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input name="invoice_date" type="date" class="form-input" value="{{ old('invoice_date', date('Y-m-d')) }}" required />
                        </div>
                        <div>
                            ...
                            <input name="due_date" type="date" class="form-input" value="{{ old('due_date', date('Y-m-d', strtotime('+30 days'))) }}" required />
                        </div>
                        <div>
                        ...
                        @if(isset($salesOrder))
                            <div>
                                ...
                                <input type="text" class="form-input bg-gray-100 dark:bg-gray-800" value="{{ $salesOrder->order_number }}" readonly />
