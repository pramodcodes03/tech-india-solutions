            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="invoice_date" name="invoice_date" type="date" class="form-input" value="{{ old('invoice_date', date('Y-m-d')) }}" required />
                    </div>
                    <div>
                        <label for="due_date">Due Date <span class="text-danger">*</span></label>
                        <input id="due_date" name="due_date" type="date" class="form-input" value="{{ old('due_date', date('Y-m-d', strtotime('+30 days'))) }}" required />
                    </div>
                    <div>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <textarea id="terms" name="terms" class="form-input" rows="4" placeholder="Payment terms...">{{ old('terms') }}</textarea>
                    </div>
                    <div>
