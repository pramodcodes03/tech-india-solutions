<x-layout.admin>
    <div x-data="invoiceEditForm()">
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Edit Invoice</h5>
        ...
        <form action="{{ route('admin.invoices.update', $invoice->id) }}" method="POST">
            ...
            <div class="panel mb-5">
                <h6 class="text-base font-semibold mb-4">Invoice Details</h6>
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="invoice_date" name="invoice_date" type="date" class="form-input" value="{{ old('invoice_date', $invoice->invoice_date) }}" required />
                    </div>
                    <div>
                        <label for="due_date">Due Date <span class="text-danger">*</span></label>
                        <input id="due_date" name="due_date" type="date" class="form-input" value="{{ old('due_date', $invoice->due_date) }}" required />
                    </div>
                    <div>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <textarea id="terms" name="terms" class="form-input" rows="4" placeholder="Payment terms...">{{ old('terms', $invoice->terms) }}</textarea>
                    </div>
                    <div>
                        <label for="notes">Notes</label>
                        <textarea id="notes" name="notes" class="form-input" rows="4" placeholder="Internal notes...">{{ old('notes', $invoice->notes) }}</textarea>
                    </div>
                </div>
            </div>
