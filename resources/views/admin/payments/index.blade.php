<x-layout.admin title="Payments">
    <div x-data="paymentList">
        <x-admin.breadcrumb :items="[['label' => 'Payments']]" />
        ...
        <div class="flex items-center justify-between gap-4 mb-5">
            ...
            <div class="flex items-center gap-3 flex-wrap">
                ...
                <select class="form-select py-2 w-48" x-model="filterMode" @change="fetchData(1)">
                ...
                <button type="button" class="btn btn-outline-danger btn-sm" x-show="searchText || filterMode || filterDateFrom || filterDateTo" @click="clearFilters()">Clear</button>
                <a href="{{ route('admin.payments.create') }}" class="btn btn-primary gap-2 whitespace-nowrap">
                    ...
                    <tbody>
                        <template x-for="(item, index) in items" :key="item.id">
                            <tr>
                                ...
                                <td class="px-4 py-2 font-semibold" x-text="item.payment_number"></td>
                                <td class="px-4 py-2">
                        ...
                        <tr x-show="items.length === 0">
                            <x-admin.empty-state
                                ...
                                description="Payments will appear here once you record them against an invoice."
                                action-url="{{ route('admin.payments.create') }}"
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data('paymentList', () => ({
                items: @json($payments->items()),
                pagination: {
