<x-layout.admin>
    <div x-data="quotationForm()">
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Create Quotation</h5>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="quotation_date" name="quotation_date" type="date" class="form-input" value="{{ old('quotation_date', date('Y-m-d')) }}" required />
                    </div>
                    <div>
                        <label for="valid_until">Valid Until</label>
                        <input id="valid_until" name="valid_until" type="date" class="form-input" value="{{ old('valid_until', date('Y-m-d', strtotime('+30 days'))) }}" />
                    </div>
                    <div>
