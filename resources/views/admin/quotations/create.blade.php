<x-layout.admin title="Create Quotation">
    <div x-data="quotationForm()">
        <x-admin.breadcrumb :items="[['label'=>'Quotations','url'=>route('admin.quotations.index')],['label'=>'Create Quotation']]" />

        <div class="flex items-center justify-between mb-6">
            <div>
                <h5 class="text-xl font-bold dark:text-white-light">Create Quotation</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the details to generate a new quotation</p>
            </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input name="quotation_date" type="date" class="form-input" value="{{ old('quotation_date', date('Y-m-d')) }}" required />
                        </div>
                        <div>
                            ...
                            <input name="valid_until" type="date" class="form-input" value="{{ old('valid_until', date('Y-m-d', strtotime('+30 days'))) }}" />
                        </div>
                        <div>
