<x-layout.admin title="Vendors">
    <div x-data="vendorList">
        ...
        <div class="flex items-center justify-between gap-4 mb-5">
            ...
            <div class="flex items-center gap-3 flex-wrap">
                ...
                @can('vendors.create')
                <a href="{{ route('admin.vendors.create') }}" class="btn btn-primary gap-2 whitespace-nowrap">
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data('vendorList', () => ({
                items: @json($vendors->items()),
                pagination: {
                    total: {{ $vendors->total() }},
                ...
                fetchData(page = 1) {
                    let url = `{{ route('admin.vendors.index') }}?page=${page}`;
                ...
                toggleStatus(id) {
                    fetch(`{{ url('admin/vendors') }}/${id}/toggle-status`, {
                        method: 'PATCH',
