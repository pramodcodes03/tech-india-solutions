<x-layout.admin title="Maintenance Logs">
    ...
    <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.assets.maintenance.export', array_merge(request()->query(), ['format' => 'xlsx'])) }}" class="btn btn-sm btn-outline-success gap-1">
            ...
            <a href="{{ route('admin.assets.maintenance.export', array_merge(request()->query(), ['format' => 'pdf'])) }}" target="_blank" class="btn btn-sm btn-outline-danger gap-1">
