    ...
    <div x-data="purchaseOrderEditForm()">
        ...
        <form action="{{ route('admin.purchase-orders.update', $purchaseOrder->id) }}" method="POST">
            ...
            <div class="panel mb-5">
                <h6 class="text-base font-semibold mb-4">Purchase Order Details</h6>
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="po_date" name="po_date" type="date" class="form-input" value="{{ old('po_date', $purchaseOrder->po_date) }}" required />
                    </div>
                    <div>
                        <label for="expected_date">Expected Date</label>
                        <input id="expected_date" name="expected_date" type="date" class="form-input" value="{{ old('expected_date', $purchaseOrder->expected_date) }}" />
                    </div>
                    <div>
            ...
            {{-- Terms & Notes --}}
            <div class="panel mb-5">
                <h6 class="text-base font-semibold mb-4">Terms & Notes</h6>
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        <label for="terms">Terms & Conditions</label>
                        <textarea id="terms" name="terms" class="form-input" rows="4" placeholder="Enter terms and conditions...">{{ old('terms', $purchaseOrder->terms) }}</textarea>
                    </div>
                    <div>
                        <label for="notes">Notes</label>
                        <textarea id="notes" name="notes" class="form-input" rows="4" placeholder="Internal notes...">{{ old('notes', $purchaseOrder->notes) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" name="action" value="draft" class="btn btn-dark">Save as Draft</button>
                <button type="submit" name="action" value="send" class="btn btn-primary">Update & Send</button>
            </div>
        </form>
    </div>
