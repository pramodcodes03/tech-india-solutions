                    ...
                    <tbody>
                        <template x-for="(item, index) in items" :key="item.id">
                            <tr>
                                ...
                                <td class="px-4 py-2" x-text="item.po_date"></td>
                                <td class="px-4 py-2" x-text="item.expected_date || '-'"></td>
                                <td class="px-4 py-2">
                                    <span class="badge"
                                        :class="{
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center justify-center gap-2">
                                        <a :href="`{{ url('admin/purchase-orders') }}/${item.id}`" class="btn btn-sm btn-outline-info">View</a>
