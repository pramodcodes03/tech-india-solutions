<x-layout.admin title="Create PO">
    <div x-data="purchaseOrderForm()">
        <x-admin.breadcrumb :items="[['label'=>'Purchase Orders','url'=>route('admin.purchase-orders.index')],['label'=>'Create PO']]" />

        <div class="flex items-center justify-between mb-6">
            <div>
                <h5 class="text-xl font-bold dark:text-white-light">Create Purchase Order</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the details to generate a new purchase order</p>
            </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <div class="lg:col-span-1">
                            ...
                            <x-admin.searchable-select name="vendor_id" :options="$vendors" placeholder="-- Select Vendor --" required />
                        </div>
                        <div>
                            ...
                            <input name="po_date" type="date" class="form-input" value="{{ old('po_date', date('Y-m-d')) }}" required />
                        </div>
                        <div>
                            ...
                            <input name="expected_date" type="date" class="form-input" value="{{ old('expected_date') }}" />
                        </div>
                        <div>
                ...
                <div class="panel !p-0">
                    ...
                    <div class="p-5 space-y-4">
                        <div>
                            ...
                            <textarea name="terms" class="form-input resize-none" rows="5" placeholder="Payment terms, delivery conditions...">{{ old('terms') }}</textarea>
                        </div>
                        <div>
                            ...
                            <textarea name="notes" class="form-input resize-none" rows="4" placeholder="Notes visible only to your team...">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
