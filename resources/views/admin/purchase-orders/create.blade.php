<x-layout.admin title="Create PO">
    <div x-data="purchaseOrderForm()">
        ...
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Create Purchase Order</h5>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="po_date" name="po_date" type="date" class="form-input" value="{{ old('po_date', date('Y-m-d')) }}" required />
                    </div>
                    <div>
                        <label for="expected_date">Expected Date</label>
                        <input id="expected_date" name="expected_date" type="date" class="form-input" value="{{ old('expected_date') }}" />
                    </div>
                    <div>
