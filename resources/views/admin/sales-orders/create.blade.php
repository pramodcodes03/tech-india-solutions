<x-layout.admin title="Create Order">
    <div x-data="salesOrderForm()">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h5 class="text-xl font-bold dark:text-white-light">Create Sales Order</h5>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Fill in the details to create a new sales order</p>
            </div>
                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input name="order_date" type="date" class="form-input" value="{{ old('order_date', date('Y-m-d')) }}" required />
                        </div>
                        <div>
