<x-layout.admin title="Edit Order">
    <div x-data="salesOrderEditForm()">
        ...
        <div class="flex items-center justify-between mb-5">
            <h5 class="text-lg font-semibold dark:text-white-light">Edit Sales Order</h5>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input id="order_date" name="order_date" type="date" class="form-input" value="{{ old('order_date', $salesOrder->order_date) }}" required />
                    </div>
                    <div>
            ...
            <div class="panel mb-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                        ...
                        <textarea id="terms" name="terms" class="form-input" rows="4" placeholder="Enter terms and conditions...">{{ old('terms', $salesOrder->terms) }}</textarea>
                    </div>
                    <div>
                        <label for="notes">Internal Notes</label>
                        <textarea id="notes" name="notes" class="form-input" rows="4" placeholder="Internal notes...">{{ old('notes', $salesOrder->notes) }}</textarea>
                    </div>
                </div>
            </div>
