                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center justify-center gap-2">
                                        <a :href="`{{ url('admin/customers') }}/${item.id}`" class="btn btn-sm btn-outline-info">View</a>
                                        <a :href="`{{ url('admin/customers') }}/${item.id}/edit`" class="btn btn-sm btn-outline-primary">Edit</a>
