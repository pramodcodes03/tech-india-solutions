...
class InvoiceSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $invoices = [
            ...
            ['num' => 'INV-2026-0001', 'sales_order_id' => 1, 'status' => 'paid',    'days_ago' => 75, 'due_days' => 30],
            ['num' => 'INV-2026-0002', 'sales_order_id' => 2, 'status' => 'paid',    'days_ago' => 60, 'due_days' => 30],
            ['num' => 'INV-2026-0003', 'sales_order_id' => 3, 'status' => 'paid',    'days_ago' => 45, 'due_days' => 30],
            // 2 partial - linked to processing SOs
            ['num' => 'INV-2026-0004', 'sales_order_id' => 4, 'status' => 'partial', 'days_ago' => 30, 'due_days' => 30],
            ['num' => 'INV-2026-0005', 'sales_order_id' => 5, 'status' => 'partial', 'days_ago' => 20, 'due_days' => 30],
            // 2 unpaid
            ['num' => 'INV-2026-0006', 'sales_order_id' => 6, 'status' => 'unpaid',  'days_ago' => 12, 'due_days' => 30],
            ['num' => 'INV-2026-0007', 'sales_order_id' => 7, 'status' => 'unpaid',  'days_ago' => 8,  'due_days' => 30],
            // 1 overdue
            ['num' => 'INV-2026-0008', 'sales_order_id' => 8, 'status' => 'overdue', 'days_ago' => 45, 'due_days' => 15],
        ];
        ...
        foreach ($invoices as $inv) {
            ...
            // Get SO data
            $so = DB::table('sales_orders')->find($inv['sales_order_id']);
            ...
            $soItems = DB::table('sales_order_items')
                ->where('sales_order_id', $inv['sales_order_id'])
                ->get();
